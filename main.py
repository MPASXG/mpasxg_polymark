...
EXCLUDED_KEYWORDS = [
    ...
    "tennis","golf","mma","ufc","f1","nascar","racing",
    "crypto","bitcoin","btc","ethereum","eth","defi","nft",
    "weather","climat","meteo","météo","temperature",
    "up or down","updown","dota","counter-strike","cs2","league of legends",
    "esport","valorant","overwatch","spread:","o/u","over/under","moneyline","handicap",
    "rebounds","assists","points o/u","kills","penta kill","total kills",
    "timberwolves","pistons","hornets","suns","bruins","panthers","canadiens","rangers",
    "sabres","senators","red wings","flyers","hurricanes","penguins","lightning","capitals",
    "solana up","xrp up","bnb up","dogecoin up","hyperliquid up",
]

EXCLUDED_SLUG_PATTERNS = [
    r"^nba-",r"^nhl-",r"^nfl-",r"^mlb-",r"^cbb-",
    r"^cs2-",r"^lol-",r"^dota2-",r"^val-",
    r"^sol-",r"^xrp-",r"^bnb-",r"^doge-",r"^hype-",
    r"updown",r"-rebounds-",r"-assists-",r"-points-",
    r"-moneyline",r"-spread-",r"-total-",r"-1h-",
    r"^gtm-",r"^lck-",r"^lpl-",
]
...
def is_excluded(m):
    ...
    for pattern in EXCLUDED_SLUG_PATTERNS:
